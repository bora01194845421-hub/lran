...
★ 반드시 준수할 사실 기반 원칙:
1. 타지자체_현황·벤치마킹·lga_responses의 'actions' 필드는
   반드시 [국제 전황 요약] 또는 [국내 물가·에너지 지표] 데이터에서
   직접 확인된 내용만 작성하세요.
2. 수집된 기사에 없는 내용(날짜·금액·사업명·지자체 발표)은
   절대 만들어 쓰지 마세요.
3. 수집된 기사에서 확인되지 않은 타지자체 사례는
   반드시 "※제언※" 접두어를 붙여 사실과 구분하세요.
   예: "※제언※ 서울시 에너지 바우처 확대 모델 도입 검토"
4. 확인된 사례가 없으면 "수집된 사례 없음 — ※제언※ ..." 형식으로 작성하세요.
...
{{
  "민생경제_분석": {{
    "지역산업": {{
      ...
      "타지자체_현황": "수집된 기사에서 확인된 타 지자체 대응 사례만 인용. 없으면 '수집된 사례 없음 — ※제언※ 유사 산업구조 타 지자체 모니터링 필요'"
    }},
    "소상공인_자영업": {{
      "level": "높음|중간|낮음|모니터링",
      "summary": "수원시 소상공인·자영업(음식점·배달·운수·유류비) 영향 분석 2~3줄",
      "key_indicator": "핵심 지표 또는 수치 1줄",
      "타지자체_현황": "수집된 기사에서 확인된 소상공인 지원 타 지자체 사례만 인용. 없으면 '수집된 사례 없음 — ※제언※ ...' 형식으로 작성"
    }},
    "시민생활": {{
      "level": "높음|중간|낮음|모니터링",
      "summary": "수원시 시민생활(도시가스·전기료·물가·취약계층) 영향 분석 2~3줄",
      "key_indicator": "핵심 지표 또는 수치 1줄",
      "타지자체_현황": "수집된 기사에서 확인된 에너지복지 타 지자체 사례만 인용. 없으면 '수집된 사례 없음 — ※제언※ ...' 형식으로 작성"
    }}
  }},
  "우선_대응과제": [
    {{
      ...
      "priority": "즉시|단기|중기",
      "근거": {{
        "타지자체_벤치마킹": "수집된 기사에서 확인된 타지자체 사례만 인용 (날짜·금액·사업명 포함). 없으면 '※제언※ ...' 형식으로 정책 방향만 제시",
        "전문가_의견": "유튜브·전문가 브리핑에서 확인된 내용만 인용. 없으면 '수집된 의견 없음'",
        "보고서_근거": "수집된 기사에서 확인된 KEEI·KIEP·KDI·IEA 등 보고서 인용 근거. 없으면 '수집된 보고서 없음'"
      }}
    }},
    {{
      "순위": 2,
      ...
      "priority": "즉시|단기|중기",
      "근거": {{
        "타지자체_벤치마킹": "수집된 기사 기반 타지자체 사례 인용 또는 '※제언※ ...'",
        "전문가_의견": "수집된 기사 기반 전문가 의견 인용 또는 '수집된 의견 없음'",
        "보고서_근거": "수집된 기사 기반 보고서 인용 또는 '수집된 보고서 없음'"
      }}
    }},
    {{
      "순위": 3,
