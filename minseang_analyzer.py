...
★ 이번 주(6/15) 반드시 반영해야 할 핵심 사실 (6/9~6/15 확인된 사실):
① 미-이란 종전 합의 타결 — 이란·미국, 호르무즈 해협 재개방 및 휴전 연장 합의 (FT·NYT)
② 트럼프, 이스라엘·헤즈볼라에 "stand down" 촉구 — 이란 합의를 계기로 중동 전면전 중단 추진 (FT)
③ 호르무즈 해협 금요일 이란 주도 재개방 예정 — 미-이란 평화 합의로 해협 통행 재개 전망 (Guardian)
④ 유가 하락 전망 — 호르무즈 재개방 시 공급 정상화로 WTI·브렌트 하락 압력
⑤ 유가: WTI $91.50, 브렌트 $94.35 (6/11) / USD/KRW 1520.21 (6/15 기준)
⑥ 미국 6/11 이란 2차 공습 단행 → 이후 협상 급진전 — 강경 압박 후 합의 도출 패턴
⑦ 트럼프 "US-Iran 합의 오늘 서명 가능" 발표 (YouTube·FT 6/15)
⑧ 호르무즈 재개방 시 수원시 수출기업 해운 운임·전쟁보험료 정상화 기대

위 ①~⑧를 분석 근거로 명시적으로 활용할 것. 지난주(6/11) 분석과 중복되는 내용은 작성 금지.
특히 ①③ 종전 합의·호르무즈 재개방이 수원시 민생경제에 미치는 긍정적 영향(물류비 하락, 유가 안정, 환율 완화)을 중점 분석할 것.
