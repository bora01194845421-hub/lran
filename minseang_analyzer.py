...
PROMPT = """6월 5일(목)~6월 8일(일·오늘)간 수집된 데이터를 종합해서 수원시 민생경제 분석과 우선 대응과제를 JSON으로 작성하세요.

★ 이번 주(6/8) 반드시 반영해야 할 핵심 사실 (6/5~6/8 확인된 사실):
① 이란 IRGC, 6/7 이스라엘 향해 탄도미사일 발사 — 2026년 4월 미-이란 휴전 이후 최초 직접 공격, 람아트 다비드 공군기지 등 표적 (FT·NYT·Al Jazeera·Bloomberg)
② 이스라엘, 6/7 베이루트 다히예 공습 — 헤즈볼라 지휘본부 표적, 2명 사망·11명 부상. 이란 미사일은 이에 대한 보복 (Al Jazeera·BBC)
③ 미-이란 걸프 직접 교전, 6/6: 미군 이란 드론 6기 격추 + 케슘 섬·레이더 시설 타격 → 이란, 쿠웨이트·바레인 미군기지 보복 공격 (BBC·CNN·Guardian)
④ 트럼프 6/8: "이란과 최종합의 매우 근접, 6/10까지 가능" 발언 + 협상 결렬 시 "타격 후 고농축우라늄 회수" 경고 (연합뉴스)
⑤ 이란, 호르무즈 해협 통행료 징수 시작 — 선박당 150~200만 달러, 글로벌 해운 비용 급등 (연합뉴스 6/8)
⑥ OPEC+ 6/7: 7월 일일 188,000bpd 증산 합의 — 페르시아만 봉쇄로 실행 불가, 그룹 생산량 4월 33.19Mbpd (2월 42.77M 대비 -22%) (Bloomberg)
⑦ IATA 6/8: 항공업계 2026년 순익 전망 50% 하향 조정 — 이란전쟁·항공유 폭등 직격 (연합뉴스)
⑧ 이스라엘 공습으로 레바논군 장교 3명 사망 (6/6) — 휴전 서명 수일 후 재발. 헤즈볼라 휴전 거부 지속 (NYT)
⑨ 유가: WTI $92.74, 브렌트 $95.44 (6/8 기준) / USD/KRW 1540.93 (6/4 1530.99 대비 +10원 추가 상승)

위 ①~⑨를 분석 근거로 명시적으로 활용할 것. 지난주(6/4) 분석과 중복되는 내용은 작성 금지.
