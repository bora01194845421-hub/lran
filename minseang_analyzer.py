  ...
  "우선_대응과제": [
    {{
      ...
      "근거": {{
        ...
        "전문가_의견": "수집된 싱크탱크·전문매체(ForeignAffairs·WarOnRocks·CFR·CSIS·AtlanticCouncil·ForeignPolicy·AlMonitor) 기사에서 이 과제와 직접 관련된 핵심 분석 1~2문장 인용. 반드시 [출처명 날짜] 형식으로 표기. 없으면 이 필드 생략",
        "보고서_근거": "(선택) 수집 기사에서 확인된 IEA·IMF·WorldBank·OECD 보고서 인용+날짜. 없으면 이 필드 생략"
      }}
    }},
    {{
      "순위": 2,
      ...
      "근거": {{
        "타지자체_벤치마킹": "(선택) 수집 기사에서 확인된 타지자체 실제 사례+출처+날짜. 없으면 이 필드 생략",
        "전문가_의견": "수집된 싱크탱크·전문매체 기사에서 이 과제 관련 핵심 분석 1~2문장 인용. [출처명 날짜] 표기. 없으면 이 필드 생략",
        "보고서_근거": "(선택) 수집 기사에서 확인된 국제기구 보고서 인용+날짜. 없으면 이 필드 생략"
      }}
    }},
    {{
      "순위": 3,
